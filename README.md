# ads2_sdk_Transformrush SDK 接入说明
...
android {
 	...
 	dependencies {
 		implementation 'com.github.HomepageMeta:ads2_sdk_Transformrush:v1.0.0'
...
### （1）引入类
```kotlin
import com.xn.ads2.ads2_sdk_transformrush.TransformrushHelper
...
TransformrushHelper.transformrushInit(this)
```

### （3)开启变现功能
```kotlin
TransformrushHelper.transformrushStart(context)
```
### （4)网络权限配置
